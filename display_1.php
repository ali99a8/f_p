...
<nav class="navbar navbar-expand-lg nav bg_nav_dis">
        ...
        <div class="text-center">
            <h1 class="mr-5 font-weight-bold"> لوحة العرض الرقمية</h1>
        </div>
    </nav>
    <div class="display_1 text-center ">
        <div class="container ">
            <div class="row box_diss d-flex justify-content-center mt-5 ">
                <!-- box1  Temp room-->
                <div class="col-md-4 col-sm-6 m-3 mt-5 ">
                ...
                <div class="container">
                  <div class="row  d-flex justify-content-center mt-3 ">
                     <div class="col-md-8    ">
                       <div class="dis_box box_show__camera p-5 mb-2">
                         <button type="button" class="btn  "><a href="http://172.20.10.2:8081/" class="camera"> <img src="https://img.icons8.com/fluency/48/000000/camera.png"/>   اضغط هنا لاضهار الكاميرا</a></button>
                       </div>
                     </div>
                  </div>
                 </div>
                <!-- box2  baby-->
                <div class="col-md-4 col-sm-6 m-3 mt-4 ">
                    <div class="dis_box box_show_2 p-5">
                      ...
                      <!-- box4   O2-->
                <div class="col-md-4 col-sm-12 m-3 mt-4 ">
